...
def main():
    ...
    summary={
      ...
      'state_design':{'standard':'L (current location only)','modql':'<L,D,T,H,A> with direct discretized demand, time, history/fairness, and local accessibility features'},
    ...
    # Browser runtime export. This is deliberately generated from the SAME
    # Q tables and SAME state encoders used above so engine.js cannot drift
    # to a different methodology representation.
    runtime_policy={
      'version':'methodology-aligned',
      'episodes_trained':EPISODES,
      'node_bit_index':IDX,
      'state_design':{'standard':'L','modql':'<L,D,T,H,A>'},
      'reward_design':{'standard':'1 / travel_cost','modql':'coverage * Jain_fairness * (1 / travel_cost)'},
      'standard_q':Q,'q1':Q1,'q2':Q2
    }
    js='/* AUTO-GENERATED by training/train_q_learning.py. Do not hand-edit. */\nvar TRAINED_POLICY = '+json.dumps(runtime_policy,separators=(',',':'))+';\n'
    ...
    print('Wrote browser runtime policy:', ROOT/'trained_policy.js')
