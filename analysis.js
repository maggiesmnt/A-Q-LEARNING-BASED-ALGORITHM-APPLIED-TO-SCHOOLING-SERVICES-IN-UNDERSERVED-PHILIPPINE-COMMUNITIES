...
function renderEvaluation(){
  ...
  document.getElementById("sub-evaluation").innerHTML=
    ...
    '<div class="card route-comparison-card"><h3>Route Behavior Comparison</h3><div class="split2 original-algorithm-split"><div class="splitcol std"><h3 class="comparison-panel-title">Existing Algorithm</h3><div id="comparison-existing-host"><div class="comparison-panel-subtitle">Reference implementation — the external baseline Q-learning system this study&rsquo;s control algorithm is based on.</div></div></div><div class="splitcol mod"><h3 class="comparison-panel-title">Proposed Algorithm</h3>'+proposedGraphHTML()+'</div></div><div class="comparison-notes" id="comparison-notes"><div id="comparison-implementation-note"></div><div id="comparison-reference-note"></div></div></div>'+
